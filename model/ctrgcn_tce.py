...
add TCE_k3
self.conv_temporal = nn.Conv1d(in_channels, redu_channels, kernel_size=3, padding=pad)
...
class TCE_k3(nn.Module):
    def __init__(self, in_channels, redu=16):
        super(TCE_k3, self).__init__()
        redu_channels = in_channels // redu
