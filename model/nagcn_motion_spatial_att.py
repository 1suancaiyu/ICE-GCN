...
class Motion_Spatial_Att(nn.Module):
    def __init__(self, in_channels, redu=16):
        ...
        self.sqeeze = nn.Conv2d(in_channels, redu_channels, kernel_size=(1,1))
        self.spatical_pooling = nn.AdaptiveAvgPool1d(1)
        self.spatial_conv = nn.Conv1d(redu_channels, redu_channels, kernel_size=1)
        self.expand = nn.Conv2d(redu_channels, in_channels, kernel_size=(1, 1))
...
class unit_gcn(nn.Module):
    def __init__(self, in_channels, out_channels, A, adaptive=True):
        ...
        self.motion_spa_att = Motion_Spatial_Att(out_channels)
